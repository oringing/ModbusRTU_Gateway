...
// 等待从机应答：第 9 个时钟周期检查 SDA 是否被从机拉低
...
static uint8_t Soft_I2C_WriteReg(uint8_t dev_addr, uint8_t reg_addr,
...
static uint8_t Soft_I2C_ReadReg(uint8_t dev_addr, uint8_t reg_addr,
